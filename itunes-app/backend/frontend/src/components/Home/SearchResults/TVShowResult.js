...
export function TVShowResult(props) {
  /**
   * @type {boolean}
  ...
  return (
    <Card className="mb-3">
      ...
      <Card.Body>
        ...
        <Card.Subtitle className="mb-2 text-muted">
          Rating: {props.result.raw.contentAdvisoryRating}
        </Card.Subtitle>
        <Card.Subtitle className="mb-2 text-muted">
          Release Date: {props.result.releaseDate.slice(0, 10)}
        </Card.Subtitle>
        <Card.Text
          dangerouslySetInnerHTML={{ __html: props.result.raw.longDescription }}
        ></Card.Text>
        <Card.Subtitle className="mb-2 text-muted">
          $ {props.result.collectionPrice}
        </Card.Subtitle>
        <Card.Link href={props.result.artistViewUrl}></Card.Link>
      </Card.Body>
